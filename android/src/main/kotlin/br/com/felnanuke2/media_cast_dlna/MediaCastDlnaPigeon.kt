...
interface MediaCastDlnaApi {
  ...
  fun subscribeToEvents(deviceUdn: String, serviceType: String)
  /** Unsubscribe from device events */
  fun unsubscribeFromEvents(deviceUdn: String, serviceType: String)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: MediaCastDlnaApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.media_cast_dlna.MediaCastDlnaApi.subscribeToEvents$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val deviceUdnArg = args[0] as String
            val serviceTypeArg = args[1] as String
            val wrapped: List<Any?> = try {
              api.subscribeToEvents(deviceUdnArg, serviceTypeArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.media_cast_dlna.MediaCastDlnaApi.unsubscribeFromEvents$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val deviceUdnArg = args[0] as String
            val serviceTypeArg = args[1] as String
            val wrapped: List<Any?> = try {
              api.unsubscribeFromEvents(deviceUdnArg, serviceTypeArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
 ...
 */
class DeviceDiscoveryApi(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  companion object {
    /** The codec used by DeviceDiscoveryApi. */
    val codec: MessageCodec<Any?> by lazy {
      MediaCastDlnaPigeonPigeonCodec()
    }
  }
  /** Called when a new device is discovered */
  fun onDeviceDiscovered(deviceArg: DlnaDevice, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDeviceDiscovered$separatedMessageChannelSuffix"
  ...
  fun onDeviceRemoved(deviceUdnArg: DlnaDevice, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDeviceRemoved$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onDeviceUpdated(deviceArg: DlnaDevice, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDeviceUpdated$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onDiscoveryError(errorArg: String, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDiscoveryError$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onDiscoveryCompleted(callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDiscoveryCompleted$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(null) {
      if (it is List<*>) {
        if (it.size > 1) {
 ...
 * Generated class from Pigeon that represents Flutter messages that can be called from Kotlin.
 */
class MediaRendererEventsApi(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  companion object {
    /** The codec used by MediaRendererEventsApi. */
    val codec: MessageCodec<Any?> by lazy {
      MediaCastDlnaPigeonPigeonCodec()
    }
  }
  /** Called when transport state changes */
  fun onTransportStateChanged(deviceUdnArg: String, stateArg: TransportState, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onTransportStateChanged$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceUdnArg, stateArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
  ...
  fun onPositionChanged(deviceUdnArg: String, positionSecondsArg: Long, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onPositionChanged$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceUdnArg, positionSecondsArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
  ...
  fun onVolumeChanged(deviceUdnArg: String, volumeInfoArg: VolumeInfo, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onVolumeChanged$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceUdnArg, volumeInfoArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
  ...
  fun onTrackChanged(deviceUdnArg: String, trackUriArg: String?, trackMetadataArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onTrackChanged$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceUdnArg, trackUriArg, trackMetadataArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
  ...
  fun onPlaybackError(deviceUdnArg: String, errorArg: String, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onPlaybackError$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceUdnArg, errorArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
 ...
 * Generated class from Pigeon that represents Flutter messages that can be called from Kotlin.
 */
class MediaServerEventsApi(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  companion object {
    /** The codec used by MediaServerEventsApi. */
    val codec: MessageCodec<Any?> by lazy {
      MediaCastDlnaPigeonPigeonCodec()
    }
  }
  /** Called when content directory is updated */
  fun onContentDirectoryUpdated(deviceUdnArg: String, containerIdArg: String, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.MediaServerEventsApi.onContentDirectoryUpdated$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceUdnArg, containerIdArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
  ...
  fun onContentDirectoryError(deviceUdnArg: String, errorArg: String, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.media_cast_dlna.MediaServerEventsApi.onContentDirectoryError$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(deviceUdnArg, errorArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
