...
protocol MediaCastDlnaApi {
  ...
  func subscribeToEvents(deviceUdn: String, serviceType: String) throws
  /// Unsubscribe from device events
  func unsubscribeFromEvents(deviceUdn: String, serviceType: String) throws
...
class MediaCastDlnaApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MediaCastDlnaApi?, messageChannelSuffix: String = "") {
    ...
    /// Subscribe to device events (transport state changes, volume changes, etc.)
    let subscribeToEventsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.media_cast_dlna.MediaCastDlnaApi.subscribeToEvents\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      subscribeToEventsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let deviceUdnArg = args[0] as! String
        let serviceTypeArg = args[1] as! String
        do {
          try api.subscribeToEvents(deviceUdn: deviceUdnArg, serviceType: serviceTypeArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      subscribeToEventsChannel.setMessageHandler(nil)
    }
    /// Unsubscribe from device events
    let unsubscribeFromEventsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.media_cast_dlna.MediaCastDlnaApi.unsubscribeFromEvents\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      unsubscribeFromEventsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let deviceUdnArg = args[0] as! String
        let serviceTypeArg = args[1] as! String
        do {
          try api.unsubscribeFromEvents(deviceUdn: deviceUdnArg, serviceType: serviceTypeArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      unsubscribeFromEventsChannel.setMessageHandler(nil)
    }
    /// Get platform version
...
protocol DeviceDiscoveryApiProtocol {
  /// Called when a new device is discovered
  func onDeviceDiscovered(device deviceArg: DlnaDevice, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when a device is removed/lost
  func onDeviceRemoved(deviceUdn deviceUdnArg: DlnaDevice, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when a device is updated
  func onDeviceUpdated(device deviceArg: DlnaDevice, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when discovery encounters an error
  func onDiscoveryError(error errorArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when discovery is completed
  func onDiscoveryCompleted(completion: @escaping (Result<Void, PigeonError>) -> Void)
}
class DeviceDiscoveryApi: DeviceDiscoveryApiProtocol {
  ...
  /// Called when a new device is discovered
  func onDeviceDiscovered(device deviceArg: DlnaDevice, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDeviceDiscovered\(messageChannelSuffix)"
  ...
  /// Called when a device is removed/lost
  func onDeviceRemoved(deviceUdn deviceUdnArg: DlnaDevice, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDeviceRemoved\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  /// Called when a device is updated
  func onDeviceUpdated(device deviceArg: DlnaDevice, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDeviceUpdated\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  /// Called when discovery encounters an error
  func onDiscoveryError(error errorArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDiscoveryError\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  /// Called when discovery is completed
  func onDiscoveryCompleted(completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.DeviceDiscoveryApi.onDiscoveryCompleted\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
///
/// Generated protocol from Pigeon that represents Flutter messages that can be called from Swift.
protocol MediaRendererEventsApiProtocol {
  /// Called when transport state changes
  func onTransportStateChanged(deviceUdn deviceUdnArg: String, state stateArg: TransportState, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when position changes during playback
  func onPositionChanged(deviceUdn deviceUdnArg: String, positionSeconds positionSecondsArg: Int64, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when volume changes
  func onVolumeChanged(deviceUdn deviceUdnArg: String, volumeInfo volumeInfoArg: VolumeInfo, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when current track changes
  func onTrackChanged(deviceUdn deviceUdnArg: String, trackUri trackUriArg: String?, trackMetadata trackMetadataArg: String?, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when an error occurs during playback
  func onPlaybackError(deviceUdn deviceUdnArg: String, error errorArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void)
}
class MediaRendererEventsApi: MediaRendererEventsApiProtocol {
  private let binaryMessenger: FlutterBinaryMessenger
  private let messageChannelSuffix: String
  init(binaryMessenger: FlutterBinaryMessenger, messageChannelSuffix: String = "") {
    self.binaryMessenger = binaryMessenger
  ...
  /// Called when transport state changes
  func onTransportStateChanged(deviceUdn deviceUdnArg: String, state stateArg: TransportState, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onTransportStateChanged\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceUdnArg, stateArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
  ...
  /// Called when position changes during playback
  func onPositionChanged(deviceUdn deviceUdnArg: String, positionSeconds positionSecondsArg: Int64, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onPositionChanged\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceUdnArg, positionSecondsArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
  ...
  /// Called when volume changes
  func onVolumeChanged(deviceUdn deviceUdnArg: String, volumeInfo volumeInfoArg: VolumeInfo, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onVolumeChanged\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceUdnArg, volumeInfoArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
  ...
  /// Called when current track changes
  func onTrackChanged(deviceUdn deviceUdnArg: String, trackUri trackUriArg: String?, trackMetadata trackMetadataArg: String?, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onTrackChanged\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceUdnArg, trackUriArg, trackMetadataArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
  ...
  /// Called when an error occurs during playback
  func onPlaybackError(deviceUdn deviceUdnArg: String, error errorArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.MediaRendererEventsApi.onPlaybackError\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceUdnArg, errorArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
...
///
/// Generated protocol from Pigeon that represents Flutter messages that can be called from Swift.
protocol MediaServerEventsApiProtocol {
  /// Called when content directory is updated
  func onContentDirectoryUpdated(deviceUdn deviceUdnArg: String, containerId containerIdArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void)
  /// Called when a content directory operation encounters an error
  func onContentDirectoryError(deviceUdn deviceUdnArg: String, error errorArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void)
}
class MediaServerEventsApi: MediaServerEventsApiProtocol {
  private let binaryMessenger: FlutterBinaryMessenger
  private let messageChannelSuffix: String
  init(binaryMessenger: FlutterBinaryMessenger, messageChannelSuffix: String = "") {
    self.binaryMessenger = binaryMessenger
  ...
  /// Called when content directory is updated
  func onContentDirectoryUpdated(deviceUdn deviceUdnArg: String, containerId containerIdArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.MediaServerEventsApi.onContentDirectoryUpdated\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceUdnArg, containerIdArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
  ...
  /// Called when a content directory operation encounters an error
  func onContentDirectoryError(deviceUdn deviceUdnArg: String, error errorArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.media_cast_dlna.MediaServerEventsApi.onContentDirectoryError\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceUdnArg, errorArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
